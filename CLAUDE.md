...
- Build only what sections 1.1, 1.4, 1.5 and 1.6 list. Everything else goes on the roadmap (section 6).
...
Current phase: 5 (session notes). Phases 4.5 and 4.6 are built; Phase 4 is skipped for now.