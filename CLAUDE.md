...
- Build only what sections 1.1 and 1.4–1.7 list. Everything else goes on the roadmap (section 6).
...
Current phase: none. Phases 4.5 to 6 are built; the owner picks the next roadmap item (section 5, 'Where we are'). Phase 4 is skipped for now.