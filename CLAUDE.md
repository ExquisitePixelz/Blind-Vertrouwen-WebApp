...
- Build only what sections 1.1, 1.4 and 1.5 list. Everything else goes on the roadmap (section 6).
...
Current phase: 4.5 (look and navigation), then 5 (session notes). Phase 4 is skipped for now.